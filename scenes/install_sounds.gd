...
@onready var sounds = {
	&"UI_Hover1" : AudioStreamPlayer.new(),
	&"UI_Hover2" : AudioStreamPlayer.new(),
	&"UI_Hover3" : AudioStreamPlayer.new(),
	&"UI_Click" : AudioStreamPlayer.new(),
	&"UI_Click2" : AudioStreamPlayer.new(),
	&"UI_Click3" : AudioStreamPlayer.new(),
	}
...
func _ready() -> void:
	...
	for i in sounds.keys():
		sounds[i].stream = load("res://audio/UI_Clicks_Sounds" + str(i) + ".mp3")
